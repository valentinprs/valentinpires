...
function CopyButton() {
  ...
  return (
    <button
      ...
      className="font-base flex items-center gap-1 text-center text-sm text-secondary transition-colors"
      type="button"
    >
...
export default function LayoutBlogPost({
  ...
  return (
    <>
      ...
      <ScrollProgress
        className="fixed top-0 z-20 h-0.5 bg-zinc-600"
        springOptions={{
          bounce: 0,
        }}
      />
